...
export { default as Select } from "./pure-components/Select/index";
...
// overall components
export { default as MainCard } from "components/overall-elements/MainCard";
export { default as CopyBan } from "components/overall-elements/CopyBan";
export { default as Summary } from "components/overall-elements/Summary";
